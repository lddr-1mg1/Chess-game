...
def draw_repitition():
    immutable_positions = tuple(sorted((piece_id, tuple(pos)) for piece_id, pos in pieces_positions.items()))  # Transforme en tuple trié car on ne peut pas séparé des élément d'un dictionnaire # aide chat gpt
